...
/**
 * The InfoBoardView displays the player's turn and pieces obtained.
 * The InfoBoardView is part of Model-View-Controller Design Pattern of the InfoBoard.
 *
...
public class InfoBoardView extends JPanel {
  ...
  public void updatePieceOwned(int turn, InfoBoardModel theModel) {
    ...
    for(int i = 0; i < theModel.getPieceOwned()[turn].size(); i++) {
      ...
      //Highlights the latest piece obtained by the user.
      if (i == 0) {
