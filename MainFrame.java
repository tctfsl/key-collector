...
public class MainFrame extends JFrame {
  ...
  public static void main(String[] args) {
    ...
    InfoBoardController infoBoardController = new InfoBoardController(infoBoardView, infoBoardModel, gameBoardModel);
  
    gameBoardModel.addObserver(infoBoardController);
